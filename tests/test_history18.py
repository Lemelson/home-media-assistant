...
class BarTests(unittest.TestCase):
    ...
    def test_current_counts_and_selection_fallback_have_same_labels(self):
        ...
        self.assertIn('Раздают: 89 · скачивают: 5',text);self.assertNotIn('при выборе',text)
        t.update(seeders=7,leechers=2);text,_=progress_text(s,t,110)
        self.assertIn('Раздают: 7 · скачивают: 2',text)
